...
import type { TChannelParticipantsRow, TChannelRow } from '../../widgets/channels/channel.types';

import { getChannelParticipantsById } from '@/entities/channel/channel-client-service';
	...
	return (
		<div className='relative flex h-full min-h-0 flex-col overflow-hidden border-l-2'>
			...
			<div className='mx-2 my-2 min-h-0 flex-1'>
				<div className='shadow-default flex h-full min-h-0 flex-col gap-1 overflow-y-auto rounded border p-2 py-2'>
					{isLoading ? (
