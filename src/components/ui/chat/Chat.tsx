...
export default function Chat({ profile }: Props) {
	...
	return (
		<div className='flex h-screen flex-col' role='complementary' aria-label='Chat panel'>
			...
			{/* User info */}
			<div className='bg-primary/40 border-gray/20 flex justify-between h-27.5 w-full flex-shrink-0 items-center  border-b-2 px-10 font-semibold shadow-sm'>
			...
			>
				...
				<div
					className={clsx(
						isDashboard
							? 'from-primary pointer-events-none absolute top-0 left-0 z-40 h-full w-full bg-gradient-to-b to-transparent dark:from-[#6366F1]'
							: 'from-primary/20 dark:from-gray/5 pointer-events-none absolute top-0 left-0 z-50 h-50 w-full bg-gradient-to-b to-transparent'
					)}
				/>
