...
import { timelineTaskPercent } from '../model/timelineTaskPercent';
...
function Timeline({ todayTasks }: { todayTasks: TTask[] }) {
	...
	return (
		<div className='text-foreground bg-side my-10 h-[600px] rounded-2xl border border-white px-5 pt-5 shadow shadow-neutral-500 dark:border-none'>
