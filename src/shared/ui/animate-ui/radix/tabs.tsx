...
import {
	MotionHighlight,
	MotionHighlightItem,
} from '@/shared/ui/animate-ui/effects/motion-highlight';
	...
	return (
		<MotionHighlightItem value={value} className='size-full'>
			<motion.button
				...
				className={cn(
					'ring-offset-background focus-visible:ring-ring data-[state=active]:text-foreground z-[1] inline-flex size-full cursor-pointer items-center justify-center rounded-sm px-2 py-1 text-sm font-medium whitespace-nowrap transition-transform focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:data-[state=active]:text-white',
					className
				)}
				{...props}
			>
