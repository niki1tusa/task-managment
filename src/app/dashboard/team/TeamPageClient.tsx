		...
		<div className='relative grid h-full grid-cols-[70%_30%] border-l'>
			...
			<div className='border-l shadow shadow-neutral-400'>
				...
				<div className='flex flex-col gap-2 px-5 py-5'>
					{activeTask ? (
						<>
							<span>Owner: {activeTask?.owner_id}</span>
							<div className='flex items-center gap-10'><Title>Participants</Title> <button type='button' onClick={mutate()}><SquarePlus/></button> </div>
